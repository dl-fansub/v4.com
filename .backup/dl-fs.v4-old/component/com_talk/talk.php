...
$(function(){
	...
	$('#chat_container').css('background','url(images/ajax_loading.gif) center no-repeat');
	...
	$('.dialogclose').click(function(){
		$('.dialogcontent').html('<div align="center"><img src="images/ajax_loading.gif" border="0" /></div>');
		$('.dialogbox').animate({
			opacity: 0,
			'margin-left': 0,
		},100, function(){
...
function PreviewImage(url) {
	...
	$('.dialogbox').animate({
		...
		$('.dialogbox').animate({
			...
			$.ajax({ url: '?stage=chat&x=manage_chat',
...
<div class="dialogbox" align="left">
  ...
  <div class="dialogcontent" align="center"><img src="images/ajax_loading.gif" border="0" /></div>
</div>
