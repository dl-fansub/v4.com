...
.navbar {
  .navbar-nav {
    ...
    box-shadow: 0 -2px 6px 0 rgba(97, 97, 97, 1);
  }
  ...
  .nav-item {
    ...
    a.nav-link {
      ...
      &.active {
        ...
        border: solid 1px #05469f;
        box-shadow: inset 0 0 2px 0 rgba(1, 132, 192, 1);
        background:
          linear-gradient(
            180deg,
            #0186c5 0%,
        ...
        &::after {
          ...
          border-color: #0961af transparent transparent transparent;
          position: absolute;
          bottom: -9px;
